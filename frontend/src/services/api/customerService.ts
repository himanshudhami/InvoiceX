...
import { Customer, CreateCustomerDto, UpdateCustomerDto, PagedResponse, PaginationParams } from './types';
...
export class CustomerService {
  ...
  async getAll(): Promise<Customer[]> {
    return apiClient.get<Customer[]>(this.endpoint);
  }
  ...
  async getPaged(params: PaginationParams = {}): Promise<PagedResponse<Customer>> {
