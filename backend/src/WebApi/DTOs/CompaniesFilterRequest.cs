...
{
    public class CompaniesFilterRequest
    {
        ...
        public Dictionary<string, object> GetFilters()
        {
            ...
            if (LogoUrl != null && !string.IsNullOrWhiteSpace(LogoUrl))
                filters.Add("logo_url", LogoUrl);
            ...
            if (Website != null && !string.IsNullOrWhiteSpace(Website))
                filters.Add("website", Website);
