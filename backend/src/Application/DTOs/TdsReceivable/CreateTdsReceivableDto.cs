...
{
    /// <summary>
    /// DTO for creating a new TDS Receivable entry
    /// </summary>
    public class CreateTdsReceivableDto
    {
        /// <summary>
        ...
        /// </summary>
        [Required(ErrorMessage = "Deductor name is required")]
        ...
        /// </summary>
        [Required(ErrorMessage = "TDS section is required")]
        ...
        /// TDS rate (percentage)
        /// </summary>
        [Required(ErrorMessage = "TDS rate is required")]
        ...
        /// TDS amount deducted
        /// </summary>
        [Required(ErrorMessage = "TDS amount is required")]
        ...
        /// Net amount received
        /// </summary>
        [Required(ErrorMessage = "Net received is required")]
