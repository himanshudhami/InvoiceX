namespace Core.Interfaces
{
    ...
    public interface IDashboardRepository
    {
        ...
        Task<(decimal TotalRevenue, decimal OutstandingAmount, decimal ThisMonthAmount, decimal OverdueAmount, int OutstandingCount, int ThisMonthCount, int OverdueCount)> GetDashboardStatsAsync();
        ...
        Task<List<(Guid Id, string InvoiceNumber, string CustomerName, decimal TotalAmount, string Status, DateOnly InvoiceDate, DateOnly DueDate)>> GetRecentInvoicesAsync(int count = 10);
    }
}